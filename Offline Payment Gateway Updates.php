...
<div style="max-width:650px; margin:40px auto; background:#ffffff; border-radius:10px; overflow:hidden; box-shadow:0 4px 15px rgba(0,0,0,0.08);">
    ...
    <!-- Header -->
    <div style="background:linear-gradient(135deg,#FFB74D,#FF9800); padding:28px; text-align:center;">
    ...
    <div style="padding:30px; color:#333; font-size:15px; line-height:1.6;">
        ...
        <p style="margin:0 0 18px 0;">
            We have received your payment details for Invoice Number: <strong>{$invoiceid}</strong>. Your payment is currently under process. 
        </p>
