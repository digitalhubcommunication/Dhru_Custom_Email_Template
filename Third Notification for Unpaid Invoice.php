...
<title>{$companyname} - Final Invoice Overdue Notice</title>
</head>
...
<div style="max-width:650px; margin:40px auto; background:#ffffff; border-radius:10px; overflow:hidden; box-shadow:0 4px 15px rgba(0,0,0,0.08);">
    ...
    <!-- Header -->
    <div style="background:linear-gradient(135deg,#D32F2F,#FF5252); padding:28px; text-align:center;">
        <h2 style="margin:0; color:#fff; font-size:22px; font-weight:600;">
            Final Invoice Overdue Notice
        </h2>
    </div>
    ...
    <div style="padding:30px; color:#333; font-size:15px; line-height:1.6;">
        ...
        <p style="margin:0 0 18px 0;">
            This is the <strong>third and final billing notice</strong> that your invoice <strong>#{$invid}</strong> is now overdue. Please settle your payment immediately to avoid service suspension or additional fees.
        </p>
